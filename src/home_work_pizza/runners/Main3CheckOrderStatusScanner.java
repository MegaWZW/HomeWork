...
import home_work_pizza.order.Order;
import home_work_pizza.order.OrderStatus;
import home_work_pizza.order.SelectedItem;
...
/**
 * Проверка статуса заказа в процессе приготовления
 */
public class Main3CheckOrderStatusScanner {
