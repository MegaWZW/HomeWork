...
public class Main3 {
    public static void main(String[] args) {
        ...
        RandomPersonNameFromFile r = new RandomPersonNameFromFile("HomeWork\\person_names.txt");
        RandomPersonNickFromFile r2 = new RandomPersonNickFromFile("HomeWork\\person_nicks.txt");
        RandomAnimalNickFromFile r3 = new RandomAnimalNickFromFile("HomeWork\\animal_nicks.txt");
